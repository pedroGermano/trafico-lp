    ...
    <section className="bg-hero bg-no-repeat bg-left-top min-h-[800px] lg:min-h-[950px] lg:mb-80">
      <motion.div
        ...
        <motion.div
          ...
          >
          <Image src={girlImg} width={206} height={495} alt="girl vetor" />
        </motion.div>
        ...
        <motion.div
          ...
          >
          <Image src={truckImg} width={811} height={395} alt="truck Img" />
        </motion.div>

        <motion.div
          variants={boyAnim}
          className="hidden lg:flex absolute right-[380px] bottom-0 z-10">
          <Image src={boyImg} width={206} height={495} alt="Boy Img" />
        </motion.div>
